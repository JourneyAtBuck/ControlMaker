{
    ...
    try{
        ...
        function importAIasShape(newFile,comp,newCtrlName)  {
            ...
            var propList = listProperties(ctrlLayer);
        ...
        function importControl(newFile) {
                ...
                if (comp != null && comp instanceof CompItem) {
                    ...
                    if (pinsArray.length) {
                        ...
                        for (p in pinsArray){ // imports a control for each selected pin
